...
/**
 *client.CreateNewProfile
 *
 * <p>
 *     Handles the creation of new profiles in the market place and ensure that the new profiles are compared to
 *     existing user profiles and that the creation is unique. The accounts are saved to a file and then added to the
 *     database's profile list.
 * </p>
...
public class CreateNewProfile extends UserProfile implements CreateNewProfileInterface {
    ...
    public CreateNewProfile(String username, String email, String password) {
     ...
     *
     * @return the user.UserProfile object of the user, or null if none exists
     */
     ...
     * by line and creates user.UserProfile objects for each valid entry.
     */
