            ...
            while (true) {
                ...
                switch (menuAction) {
                    case "1": // Search functionality
                        ...
                        } else if (UserProfile instanceof Users) {
                                    ...
                                    if (posts instanceof ArrayList<?>) {
                                        ...
                                        for (Object obj : (ArrayList<?>) posts) {
                                            if (obj instanceof ItemListing) {
                                                userPosts.add((ItemListing) obj);
                                            } else {
                                                System.out.println("Found non-ItemListing object");
                                                return;
                                            }
                                        }

                                        System.out.println();
                                        for (ItemListing post : userPosts) {
                                        ...
                                        writer.println(userPosts.get(commentMenu - 1).getTitle());
                    ...
                    case "2": // Content management
                        ...
                        if (postAction.equalsIgnoreCase("1")) {
                            ...
                            System.out.println("Enter title of the post to delete:");
