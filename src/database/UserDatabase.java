...
import java.sql.*;
/**
 * The database.UserDatabase class handles SQL operations for user accounts.
...
public class UserDatabase implements DatabaseInterface {
    ...
    /**
     * Constructs a database.UserDatabase using the given SQL connection.
     *
     ...
     *
     * @param obj the user object to save (must be a user.UserProfile)
     */
    @Override
     ...
     * @return the user.UserProfile if found, or null if not
     */
    @Override
     ...
     *
     * @param obj the updated user object (must be a user.UserProfile)
     */
    @Override
