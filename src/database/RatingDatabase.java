...
/**
 * The database.RatingDatabase class handles storing and retrieving seller ratings.
...
public class RatingDatabase implements DatabaseInterface {
    ...
    /**
     * Constructs a database.RatingDatabase with the given SQL connection.
     *
     ...
     *
     * @param obj the rating to save (must be a rating.RatingEntry object)
     */
    @Override
