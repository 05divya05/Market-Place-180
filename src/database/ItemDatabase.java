...
import java.sql.*;
/**
 * The database.ItemDatabase class handles all SQL operations related to item listings.
...
public class ItemDatabase implements DatabaseInterface {
    ...
    /**
     * Constructs a new database.ItemDatabase using the given SQL connection.
     *
     ...
     * @return the loaded item.Item object, or null if not found
     */
    @Override
     ...
     *
     * @param obj the updated item.Item object (cast from Object)
     */
    @Override
