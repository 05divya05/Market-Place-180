...
public class ItemListing implements Serializable {
    ...
    private String title,description,category,imagePath;
    private double price;
    private int quantity;

    public ItemListing(String seller,String title,String desc,double price,
                       String cat,String img,int qty){
        this.seller=seller;this.title=title;this.description=desc;
        this.price=price;this.category=cat;this.imagePath=img;this.quantity=qty;
    }
    ...
    public void setDescription(String d){description=d;} public void setPrice(double p){price=p;}
    public void setCategory(String c){category=c;} public void setImagePath(String p){imagePath=p;}
    ...
    public static ItemListing fromFile(String l){
        String[] f=l.split(",",7); if(f.length!=7) return null;
