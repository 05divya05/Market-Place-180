...
public class FriendScreen extends JPanel {
    ...
    private JPanel createNavBar() {
        ...
        JPanel[] pages = {
                new SearchScreen(writer, objectInputStream, appGUI, user),
                new ContentScreen(reader, writer, objectInputStream, user),
                new HomeScreen(reader, objectInputStream, writer, appGUI, user),
                new FriendScreen(reader, writer, objectInputStream, appGUI, user),
                new ProfileScreen (reader, writer,objectInputStream,appGUI,user),
        };
    ...
    private void refreshFriendBlockedLists() {
        ...
        if (!user.getBlockedFriends().getFirst().equals("EmptyBlockedList")) {
            for (String blockedUser : user.getBlockedFriends()) {
